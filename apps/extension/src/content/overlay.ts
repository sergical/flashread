import type { Word, FlashReadSettings, ReadingStats } from '@flashread/core';
import { RSVPEngine, type RSVPEvent, splitWordAtORP, formatDuration, MIN_WPM, MAX_WPM, DEMO_TEXT, FONT_FAMILIES } from '@flashread/core';
